...
<html lang=\"en\">
  <head>
    ...
    <style>
      ...
      .preview { margin-top: 2rem; padding: 1rem; border: 1px solid #ddd; border-radius: 6px; background: #fafafa; min-height: 120px; display: flex; align-items: center; justify-content: center; }
...
def _generate_svg(lines: Iterable[str], style: int | None = None) -> bytes:
...
def index():
    ...
    if request.method == "POST":
        ...
        try:
            svg_bytes = _generate_svg(lines, style=style)
